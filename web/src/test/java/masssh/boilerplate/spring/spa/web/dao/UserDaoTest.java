...
import masssh.boilerplate.spring.spa.web.annotation.TestSetUp;
...
import masssh.boilerplate.spring.spa.web.security.Roles;
...
class UserDaoTest {
    ...
    public static UserRow createRow() {
        return new UserRow(null, "userId", "userName", Roles.ROLE_USER, "email", Locale.JAPAN.toString(), "passwordHash", "accessToken", null);
    }
    ...
    void crud() {
        ...
        assertThat(userRow.getRole()).isEqualTo(Roles.ROLE_USER);
