...
import masssh.boilerplate.spring.web.config.property.ApplicationProperty.ElasticsearchProperty;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "masssh.boilerplate.spring.web.dao.elasticsearch")
