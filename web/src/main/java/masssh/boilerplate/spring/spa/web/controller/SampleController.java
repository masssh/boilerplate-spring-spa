...
import masssh.boilerplate.spring.spa.web.advice.ApplicationExceptionHandler;
import masssh.boilerplate.spring.spa.web.dao.SampleDao;
import masssh.boilerplate.spring.spa.web.dao.elasticsearch.FooRepository;
import masssh.boilerplate.spring.spa.web.model.document.FooDocument;
import masssh.boilerplate.spring.spa.web.model.request.SampleRequest;
import masssh.boilerplate.spring.spa.web.model.response.SuccessResponse;
...
public class SampleController {
     ...
     * See also {@link ApplicationExceptionHandler}.
     */
    @PostMapping("/sample2")
